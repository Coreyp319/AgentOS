...
These are quality seeking and compromise on time, expect 1-5 minute run times.

Info in workflows. 10S Nodes should now be on registry/manager.

Lora: https://huggingface.co/TenStrip/LTX2.3_Distilled_Lora_1.1_Experiments/tree/main

Kijai Split files for 10Eros FP8 Transformer version (not recommended use fp8_mixed) https://huggingface.co/Kijai/LTX2.3_comfy/tree/main
